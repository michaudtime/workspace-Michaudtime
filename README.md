# com-chilipeppr-workspace-micahudtime
A ChiliPeppr Workspace micahudtime.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / micahudtime
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-micahudtime |
| Name                  | Workspace / micahudtime |
| Description           | A ChiliPeppr Workspace micahudtime. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/michaudtime/workspace-Michaudtime/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/michaudtime/michaudtimegrbl |
| Github URL            | http://github.com/michaudtime/workspace-Michaudtime |
| Test URL              | https://preview.c9users.io/michaudtime/michaudtimegrbl/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/michaudtime/workspace-Michaudtime/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-micahudtime"], // the id you gave your workspace
      function(myWorkspaceMicahudtime) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / micahudtime just got loaded.", myWorkspaceMicahudtime);
        myWorkspaceMicahudtime.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-micahudtime"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / micahudtime"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace micahudtime."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/michaudtime/workspace-Michaudtime/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/michaudtime/michaudtimegrbl"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/michaudtime/workspace-Michaudtime"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://michaudtimegrbl-michaudtime.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
